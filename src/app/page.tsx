...
export default function Home() {
  return (
    <main className="flex min-h-screen  items-start justify-between ml-[100px]">
      <div className="main-content  w-full h-svh overflow-hidden ">
        ...
        <section className="massenger-filter flex items-center h-[90px] w-full pl-[24px] border-b overflow-x-auto">
          <ChatFilter />
        </section>
      ...
      <div className="right-bar flex flex-col items-center w-[325px]  h-svh border-l  border-b shrink-0">
